...
; ---------------------------------------------------------------------------
M01:
		db  75h,0F3h,0BDh, 75h,	54h,0BBh, 75h, 41h; 0
...
M02:		db  75h,0E1h,0BDh, 64h,	75h,0E7h,0BCh, 75h; 0 
...
M03:		db  75h, 5Fh,0BEh, 75h,0DBh,0BDh, 75h,0DBh; 0 
...
byte_C35C:	db 0FEh, 0Ch, 61h, 0Ah,0FFh; 0
byte_C361:	db 0FEh, 0Ch, 62h, 0Ah,0FFh; 0
...
byte_C3D8:	db 0FEh,   1, 9Bh,   1,0FEh,   3, 3Ah,0FEh; 0
		...
		db    3,0FFh		; 112
byte_C44A:	db 0FEh, 0Fh, 9Ch,   2,	40h, 43h, 3Bh, 3Fh; 0 
		db  42h, 3Ah, 3Eh, 41h,	39h, 3Dh, 40h, 38h; 8
		db  3Ch, 3Fh, 37h, 3Bh,	3Eh, 9Ch,   6,0FFh; 16
byte_C462:	db 0FCh,   0,0FEh, 0Fh,	9Ch,   1,0FEh, 0Eh; 0 
...
byte_C53F:	db 0FEh, 0Fh,0FDh,   1,	  1, 90h,   6, 2Fh; 0 
		db  2Eh, 2Dh, 2Ch, 2Bh,	30h,0FFh; 8
byte_C54D:	db 0FEh, 0Fh,0FDh,   2,	  1,0A3h,   9,0A0h; 0 
		db    3, 3Eh, 40h,0A1h,	  6, 40h, 3Ch,0FFh; 8
byte_C55D:	db 0FEh, 0Fh,0FDh,   1,	  1,0A3h,   1, 41h; 0 
		db  46h, 45h, 43h, 41h,	46h,0A5h,   2,0FFh; 8
byte_C56D:	db 0FEh, 0Ch,0FDh,   4,	  1, 9Ch, 0Ch, 37h; 0 
		db  3Ch,0FFh		; 8
byte_C577:	db 0FEh, 0Fh,0FDh,   1,	  1,0A8h,   4, 43h; 0 
		db  40h, 3Ch, 40h, 43h,	48h,0FFh; 8
byte_C585:	db 0FEh, 0Ah,0FDh,   1,	  1,0A3h,   4, 40h; 0 
		db  3Ch, 37h, 3Ch, 40h,	43h,0FFh; 8
byte_C593:	db 0FEh, 0Ah,0FDh,   1,	  1,0A0h,   4, 3Ch; 0 
...
byte_C5A1:	db 0FCh,   0,0FEh, 0Dh,0FBh, 0Fh, 74h,	 1; 0
		...
		db 0FFh			; 24
byte_C5BA:	db 0FEh, 0Fh,0FDh,   2,	  1,0A5h,   2, 46h; 0 
		db  47h, 48h, 47h, 46h,	45h,0FFh; 8
byte_C5C8:	db 0FEh, 0Dh,0FDh,   3,	  1,0FCh,   0,0FBh; 0 
