Shifted4Sprites:db 0C0h,   0,0E0h,   0,	14h,   0, 77h,	 0, 14h,   0,0E0h
					; DATA XREF: Sprite8x8_XOR_Preshifted+1Co
...
PLAYER_WALK:	db    0,   0,	0,   0,	10h,   0,   0, 20h,   0,   0, 21h
					; DATA XREF: Sprite24x32_Player+16o
					; swapBigSprite+Co
...
PLAYER_2GUN_DIE:db    0,   0,	0,   0,	  0,   0,   0,	 0,0E0h,   0,	1
		...
		db    2,0DFh, 10h,   0,	5Eh,   0,   0, 16h
;
Pneumo_Hammer:	db 11111111b,11110101b,	1010101b
		db 11000000b,	     0,	     10b
		db 11011111b,11111110b,10101001b
		db 11000000b,	     0,	     10b
		db 11111111b,11010101b,	1010101b
		db	   0,	     0,	       0
		db	   0,  110100b,	       0
		db	   0,  111000b,	       0
		db	   0,  110100b,	       0
		...
		db	   0,  111000b,	       0
		db	   0,	     0,	       0
		db	   1, 1101010b,10000000b
		db	 10b,11111101b,	1000000b
		db	110b,11111110b,10100000b
		db     1101b,11111101b,	1010000b
		db    11011b,11111110b,10101000b
		db   111011b,11111101b,	1010100b
		db	   0,	     0,	       0
		db 11101111b,11111101b,	1010101b
